...
function AscensionResult(props) {
  if (!props.renderAscension) return <></>;

  return (
    <>
      <h3 className="my-5">Ascensões: </h3>
      <Row className="mt-3 image-results xs-max-250px row justify-content-center mx-auto">
        ...
        <Col xs="5" sm="2">
          <div className="image-container">
            <img
              src={props.images.payload.character.localSpecialty.iconUrl}
        ...
        <Col xs="5" sm="2">
          ...
          <p>{props.numberWithCommas(props.data.mora)}</p>
        </Col>
      </Row>
      <Row className="mt-3 image-results xs-max-250px row justify-content-center mx-auto">
        <Col xs="5" sm="2">
          <div className="image-container">
            <img
              src={props.images.payload.character.ascensionMaterials[0].iconUrl}
        ...
        <Col xs="5" sm="2">
          <div className="image-container">
            <img
              src={props.images.payload.character.ascensionMaterials[1].iconUrl}
        ...
        <Col xs="5" sm="2">
          <div className="image-container">
            <img
              src={props.images.payload.character.ascensionMaterials[2].iconUrl}
        ...
        <Col xs="5" sm="2">
          <div className="image-container">
            <img
              src={props.images.payload.character.ascensionMaterials[3].iconUrl}
      ...
      <Row className="mt-3 image-results xs-max-350px row justify-content-center mx-auto">
        <Col xs="4" sm="2">
          <div className="image-container">
            <img
              src={
                props.images.payload.character.commonAscensionMaterials[0]
                  .iconUrl
              }
        ...
        <Col xs="4" sm="2">
          <div className="image-container">
            <img
              src={
                props.images.payload.character.commonAscensionMaterials[1]
                  .iconUrl
              }
        ...
        <Col xs="4" sm="2">
          <div className="image-container">
            <img
              src={
                props.images.payload.character.commonAscensionMaterials[2]
                  .iconUrl
              }
...
export default AscensionResult;
